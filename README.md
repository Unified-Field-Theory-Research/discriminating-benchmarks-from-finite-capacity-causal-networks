...
This repository is the isolated Paper 14 workspace for the finite-capacity
emergent-spacetime program.

Paper 14 target:

> Starting from the closed Paper 13 conditional external physical evidence
> intake theorem, formulate finite network-native discriminating benchmark
> structure while preserving finite capacity, locality, bounded transfer,
...
> promotion-gate compatibility, evidence-intake compatibility, and
> compatibility with the upstream geometry, curvature, dynamics,
...
> validation readout, physical-promotion gate, and external physical evidence
> intake packages.
...
target, comparator, and regime descriptors. `DBM-004` is the active next
obligation: define finite benchmark outcome, uncertainty, and audit-status
descriptors.
...
Persistent boundary tokens: benchmark recovery; prediction success;
...
- [LICENSE](LICENSE): code/tooling under MIT; manuscripts, diagrams,
  ...
  otherwise.
- [CITATION.cff](CITATION.cff): citation metadata for this Paper 14 skeleton.
- [OPEN_SOURCE.md](OPEN_SOURCE.md): provenance, credit, and non-promotion
  framing.

## Layout

- `GPD/publication/discriminating-benchmarks-theorem/manuscript/`: Paper 14
...
- `docs/discriminating_benchmarks_theorem.md`: theorem target, closed
  interface rungs, planned future rungs, and residual promotion obligations.
- `rust/cclab_accel/tests/discriminating_benchmarks.rs`: Rust guard that keeps
  the skeleton non-promoting and bound to Papers 1-13.
